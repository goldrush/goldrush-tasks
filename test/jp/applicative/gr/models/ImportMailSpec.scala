...
class ImportMailSpec extends fixture.FlatSpec with Matchers with AutoRollback {
  ...
  it should "create new record" in { implicit session =>
    val created = ImportMail.create(receivedAt = DateTime.now, mailSubject = "MyString", mailBody = "MyString", mailFrom = "MyString", mailSenderName = "MyString", matchingWayType = "MyString", foreignType = "MyString", sexType = "MyString", createdAt = DateTime.now, updatedAt = DateTime.now)
